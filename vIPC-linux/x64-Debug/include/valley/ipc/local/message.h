...
class LIBVALLEY_IPC_EXPORT Message
{
public:
...
public:
    ...
    static void make_reply(const Message& request, Message& reply);
...
class LIBVALLEY_IPC_EXPORT Message_view
{
public:
    ...
    static void make_reply(const Message_view& request, Message& reply);
