...
class LIBVALLEY_BASE_EXPORT Channel
{
public:
    ...
    class LIBVALLEY_BASE_EXPORT Publisher
    {
    public:
    ...
    private:
        class Impl;
        Storage<Impl, 16, 8> impl_;
    };

    struct LIBVALLEY_BASE_EXPORT Subscriber
    {
